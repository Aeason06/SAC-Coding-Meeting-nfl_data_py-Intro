...
Unfortunately, installing this package sucks. It works as intended on Python versions 3.10-12, but  we are going to try to get around installing older Python versions by using this line to install nfl_data_py. There are CSV files in the files folder of this repo if we can't get it working. <br>
